...
// I'm sure there's a better way to do this, but I don't know what it is. You need a [#]  (0 to x) for each bodyArray object that is programed in your system. The count of bodyArray objects is obtained by the previous line of code. Run $ node ./example.js to see the result.
  ...
  console.log('   circuitId: ' + config.bodyArray[13].circuitId);
  console.log('     name: ' + config.bodyArray[13].name);
  console.log('   circuitId: ' + config.bodyArray[14].circuitId);
  console.log('     name: ' + config.bodyArray[14].name);
  console.log('   circuitId: ' + config.bodyArray[15].circuitId);
  console.log('     name: ' + config.bodyArray[15].name);
  console.log('   circuitId: ' + config.bodyArray[16].circuitId);
  console.log('     name: ' + config.bodyArray[16].name);
